...
<title>Reporte Solicitudes por Tecnico</title>
...
<form name='form1' id='form1' autocomplete='off' target="_blank" action="reporte_solicitudes_tecnico.php" method='post'/>
<div class='cont_frame'>
<h1>Parametros Reporte Solicitudes por Tecnico</h1>
