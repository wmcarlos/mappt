...
require_once('../controladores/corTtipo_superficie.php');
$objFunciones = new clsFunciones;
$operacion = $lcOperacion;
$listo = $lcListo;
if(($operacion!='buscar' && $listo!=1) || ($operacion!='buscar' && $listo==1))
{
$id = $objFunciones->ultimo_id_plus1('ttipo_superficie','id');
}
?>
...
<title>Gestion Tipo de Superficie</title>
...
<?php $objFunciones->botonera_general('Ttipo_superficie','total',$id); ?>
</div>
</form>
<!--
	Codigo
