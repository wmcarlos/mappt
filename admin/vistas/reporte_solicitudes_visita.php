<?php 
	...
	$cad = $objSolicitud->getReportVisita($tecnico);
	...
	<html>
	<head>
		<title>Reporte de Solicitudes por Visitas de Tecnicos</title>
		<style type="text/css">
			table#customers{
				width: 100%;
			}
	...
	<div id="content" style="height:980px;">
	   ...
	   <center><h3>Reporte de Solicitudes por Visitas de Tecnicos</h3></center>
