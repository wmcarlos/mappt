...
require_once('../controladores/corTfuente_agua.php');
$objFunciones = new clsFunciones;
$operacion = $lcOperacion;
$listo = $lcListo;
if(($operacion!='buscar' && $listo!=1) || ($operacion!='buscar' && $listo==1))
{
$id = $objFunciones->ultimo_id_plus1('tfuente_agua','id');
}
?>
...
<title>Gestion Fuente de Agua</title>
...
<?php $objFunciones->botonera_general('Tfuente_agua','total',$id); ?>
</div>
</form>
<!--
	Codigo
