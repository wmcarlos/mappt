...
require_once('../controladores/corTmetodo_riego.php');
$objFunciones = new clsFunciones;
$operacion = $lcOperacion;
$listo = $lcListo;
if(($operacion!='buscar' && $listo!=1) || ($operacion!='buscar' && $listo==1))
{
$id = $objFunciones->ultimo_id_plus1('tmetodo_riego','id');
}
?>
...
<title>Gestion Método de Riego</title>
...
<?php $objFunciones->botonera_general('Tmetodo_riego','total',$id); ?>
</div>
</form>
<!--
	Codigo
