<?php 
	...
	$cad = $objSolicitud->getReportHistorico($cedula);
	...
	<html>
	<head>
		<title>Reporte Historico de Solicitudes por Productor</title>
		<style type="text/css">
			table#customers{
				width: 100%;
			}
	...
	<div id="content" style="height:980px;">
	   ...
	   <center><h3>Historico de Solicitudes por Productor</h3></center>
