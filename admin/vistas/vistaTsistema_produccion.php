...
require_once('../controladores/corTsistema_produccion.php');
$objFunciones = new clsFunciones;
$operacion = $lcOperacion;
$listo = $lcListo;
if(($operacion!='buscar' && $listo!=1) || ($operacion!='buscar' && $listo==1))
{
$id = $objFunciones->ultimo_id_plus1('tsistema_produccion','id');
}
?>
...
<title>Gestion Sistema de Producción</title>
...
<?php $objFunciones->botonera_general('Tsistema_produccion','total',$id); ?>
</div>
</form>
<!--
	Codigo
