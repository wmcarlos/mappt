...
require_once('../controladores/corToficina.php');
$objFunciones = new clsFunciones;
$operacion = $lcOperacion;
$listo = $lcListo;
if(($operacion!='buscar' && $listo!=1) || ($operacion!='buscar' && $listo==1))
{
$id = $objFunciones->ultimo_id_plus1('toficina','id');
}
?>
...
<?php $objFunciones->botonera_general('Toficina','total',$id); ?>
</div>
</form>
<!--
	Codigo
