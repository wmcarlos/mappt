...
require_once('../controladores/corTespecie_ave.php');
$objFunciones = new clsFunciones;
$operacion = $lcOperacion;
$listo = $lcListo;
if(($operacion!='buscar' && $listo!=1) || ($operacion!='buscar' && $listo==1))
{
$id = $objFunciones->ultimo_id_plus1('tespecie_ave','id');
}
?>
...
<title>Gestion Especie de Aves</title>
...
<?php $objFunciones->botonera_general('Tespecie_ave','total',$id); ?>
</div>
</form>
<!--
	Codigo
