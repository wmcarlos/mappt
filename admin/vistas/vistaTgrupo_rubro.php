...
require_once('../controladores/corTgrupo_rubro.php');
$objFunciones = new clsFunciones;
$operacion = $lcOperacion;
$listo = $lcListo;
if(($operacion!='buscar' && $listo!=1) || ($operacion!='buscar' && $listo==1))
{
$id = $objFunciones->ultimo_id_plus1('tgrupo_rubro','id');
}
?>
...
<title>Gestion Grupo de Rubro</title>
...
<?php $objFunciones->botonera_general('Tgrupo_rubro','total',$id); ?>
</div>
</form>
<!--
	Codigo
