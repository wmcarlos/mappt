...
function botonera_general($clase,$salir='total',$id){$botonera = '<table border="1" class="botonera datos" align="center"><tr><td class="btn-incluir"><input type="button" name="btnincluir" onclick="Incluir(\''.$id.'\');"  /></td><td class="btn-buscar" ><input type="button" name="btnbuscar" class="btn_buscar" clase="'.$clase.'"  salir="'.$salir.'" /></td><td class="btn-modificar"><input type="button" name="btnmodificar" onclick="Modificar();" disabled  /></td><td class="btn-eliminar"><input type="button" name="btneliminar" onclick="Eliminar();" disabled /></td><td class="btn-guardar"><input type="submit" name="btnguardar" class="validaciones" disabled value="" /></td><td class="btn-cancelar"><input type="button" name="btncancelar" onclick="Cancelar(\''.$clase.'\');" disabled  /><input type="hidden" id="txtreloadclass" value="'.$clase.'"/></td><tr></table>';print($botonera);}
