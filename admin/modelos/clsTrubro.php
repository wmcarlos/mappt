...
{
$lrTb=$this->ejecutar("select * from trubro where((id like '%$valor%') or (nombre like '%$valor%'))");
...
{
return $this->ejecutar("insert into trubro(id,nombre)values('$this->acId','$this->acNombre')");
}
...
{
return $this->ejecutar("update trubro set id = '$this->acId', nombre = '$this->acNombre' where(id = '$this->acId')");
}
